    ...
    internal static class ValleyPatch
    {
        static void Postfix(Map map, GenStepParams parms)
        {
            ...
            foreach (IntVec3 current in map.AllCells)
            {
                ...
                elevation[current] *= (Math.Min(Rand.Range(valleyMap.minHillEdgeMultiplier, valleyMap.maxHillEdgeMultiplier), Rand.Range(valleyMap.minHillEncroachment, valleyMap.maxHillEncroachment) * 2) * distance / size);
            }
        }
    }
}
