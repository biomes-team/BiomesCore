...
namespace BiomesCore.ThingComponents
{
	...
	public class DeathActionWorker_CorpseThingSpawner : DeathActionWorker
	{
		public override void PawnDied(Corpse corpse, Lord prevLord)
		{
			...
			if (comp != null)
			{
				FilthMaker.TryMakeFilth(corpse.Position, corpse.Map,
					DefDatabase<ThingDef>.GetNamedSilentFail(comp.Props.filthDef), comp.Props.filthAmount, FilthSourceFlags.None);
